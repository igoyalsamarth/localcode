...
class TestRepositoryBootstrap:
    ...
    def test_get_or_create_default_model_creates_new(self, db_session):
        ...
        assert model.name == "minimax-m2.7:cloud"
        assert model.input_cost_per_token == Decimal("0.30") / Decimal(1_000_000)
        assert model.output_cost_per_token == Decimal("1.20") / Decimal(1_000_000)
